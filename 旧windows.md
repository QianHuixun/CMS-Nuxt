...
说明：本总览按页面使用场景和接口详情条目统计，共 24 项；其中部分路径会在不同页面复用，例如论文、专著、课题、软著专利的分页查询接口。

| 模块 | 接口 | 方法 | 路径 |
| --- | --- | --- | --- |
| 核心资源库页面 | 获取现有数据库信息 | GET | `/api/v1/databases` |
| 核心资源库页面 | 获取自研工具信息 | GET | `/api/v1/tools` |
| 学术动态页面 1 | 获取人才信息概要列表 | GET | `/api/v1/talents` |
| 学术动态页面 1 | 获取词云列表 | GET | `/api/v1/wordClouds` |
| 学术动态页面 1 | 获取课题概要列表 | GET | `/api/v1/projects/paginate` |
| 学术动态页面 2 | 获取论文列表 | GET | `/api/v1/papers/paginate` |
| 学术动态页面 2 | 获取著作列表 | GET | `/api/v1/books/paginate` |
| 学术动态页面 2 | 获取软著专利列表 | GET | `/api/v1/softwarePatents/paginate` |
| 学术动态页面 2 | 获取活动剪影列表 | GET | `/api/v1/activityPhotos/paginate` |
| 人才详情页面 | 获取人才详情 | GET | `/api/v1/talents/{id}` |
| 软著专利概览页面（复用拆分） | 查询软著专利列表 | GET | `/api/v1/softwarePatents/paginate` |
| 软著专利概览页面 | 获取软著专利统计 | GET | `/api/v1/softwarePatents/stats` |
| 论文概览页面（复用拆分） | 查询论文列表 | GET | `/api/v1/papers/paginate` |
| 论文概览页面 | 获取论文统计 | GET | `/api/v1/papers/stats` |
| 专著概览页面（复用拆分） | 查询专著列表 | GET | `/api/v1/books/paginate` |
| 专著概览页面 | 获取专著统计 | GET | `/api/v1/books/stats` |
| 课题概览页面（复用拆分） | 查询课题列表 | GET | `/api/v1/projects/paginate` |
| 课题概览页面 | 获取课题统计 | GET | `/api/v1/projects/stats` |
| 活动概览页面 | 查询活动列表 | GET | `/api/v1/activities/paginate` |
| 软著专利详情 | 查询软著专利详情 | GET | `/api/v1/softwarePatents/{id}` |
| 论文详情 | 查询论文详情 | GET | `/api/v1/papers/{id}` |
| 专著详情 | 查询专著详情 | GET | `/api/v1/books/{id}` |
| 课题详情 | 查询课题详情 | GET | `/api/v1/projects/{id}` |
| 活动详情 | 查询活动详情 | GET | `/api/v1/activities/{id}` |
