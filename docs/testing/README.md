...
- `book-simulation-test-plan.md`
- `book-simulation-test-report.md`

说明：

- 5.2 书籍仿真录入最小版已完成最小自动化测试
...
- `core-resource-test-plan.md`
- `core-resource-test-report.md`

说明：

- 核心资源库管理已完成前后端构建验证
- 核心资源库管理已完成 migration 幂等验证
- 核心资源库管理已完成前台只读接口冒烟验证
- 核心资源库管理未做全量 E2E 测试

## 系统基础配置管理

- `system-base-config-test-plan.md`
- `system-base-config-test-report.md`

说明：

- 系统基础配置管理已完成前后端构建验证
- 系统基础配置管理已完成 migration 幂等验证
- 系统基础配置管理已完成前台只读接口冒烟验证
- 系统基础配置管理未做全量 E2E 测试
