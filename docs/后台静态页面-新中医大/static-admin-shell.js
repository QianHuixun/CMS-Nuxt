const STATIC_PAGE_MAP = {
  ...
  专家库管理: "人才与对应科研管理/专家库管理.html",
  课题时空管理: "人才与对应科研管理/课题时空管理.html",
  书籍导入: "论文著作与成果管理/书籍导入.html",
  仿真录入: "论文著作与成果管理/仿真录入.html",
  词云: "自动化辅助/词云.html",
  图表生成: "自动化辅助/图表生成.html",
        ...
        <aside class="hidden w-64 shrink-0 flex-col bg-[#1f2747] text-slate-100 lg:flex">
          <div class="border-b border-white/10 px-5 py-5">
            <div class="flex items-center gap-3">
              <div class="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-400 to-indigo-500 text-sm font-black text-white panel-glow">XY</div>
              <div>
                <p class="text-lg font-bold">新中医大 CMS</p>
                <p class="text-xs text-slate-400">后台管理系统</p>
              </div>
            </div>
          </div>
